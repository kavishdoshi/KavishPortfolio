          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className='w-1/2 flex-col items-center self-center lg:w-full lg:text-center'> 
              ...
              <div className='flex items-center self-start mt-2 lg:self-center'>
                <Link href="/KavishDoshiResume.pdf" target={"_blank"} className='md:p-2 md:px-4 md:text-base flex items-center bg-dark text-light p-2.5 px-6 rounded-lg lext-lg font-semibold hover:bg-light hover:text-dark border-2 border-solid border-transparent hover:border-dark dark:text-dark dark:bg-light hover:dark:bg-dark hover:dark:border-light hover:dark:text-light' download={true}>
