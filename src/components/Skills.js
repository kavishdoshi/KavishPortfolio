...
const Skill = ({name, x, y}) => {
    return (
        <motion.div className='flex items-center justify-center rounded-full font-semibold bg-dark text-light py-3 px-6 shadow-dark cursor-pointer absolute dark:bg-light dark:text-dark lg:py-2 lg:px-4 md:text-sm md:py-1.5 md:px-3 xs:bg-transperent xs:dark:bg-transparent xs:text-dark xs:dark:text-light xs:text-bold lg:p-6 md:p-4 xs:text-xs xs:p-2' 
  ...
  return (
        <>
            ...
            <div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] md:bg-circularLightMd md:dark:bg-circularDarkMd sm:bg-circularLightSm sm:dark:bg-circularDarkSm lg:bg-circularLightLg lg:dark:bg-circularDarkLg '>
                <motion.div className='flex items-center justify-center rounded-full font-semibold bg-dark text-light p-8 shadow-dark cursor-pointer dark:bg-light dark:text-dark lg:py-2 lg:px-4 md:text-sm md:py-1.5 md:px-3 xs:bg-transperent xs:dark:bg-transparent xs:text-dark xs:dark:text-light xs:text-bold lg:p-6 md:p-4 xs:text-xs xs:p-2' whileHover={{scale:1.05}}>
                    Web
                </motion.div>
                ...
                <Skill name="Microsoft Azure" x="15vw" y="-20vw" />
